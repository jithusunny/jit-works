...
export const projects: Project[] = [
  ...
  },
  {
    ...
    status: 'Live',
    statusTone: 'live',
    tagline: 'Your personal tools, kept fully private, offline, and end-to-end encrypted.',
    hardPart: 'Fully usable with no network, and the server never sees your data.',
